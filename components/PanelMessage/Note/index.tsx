...
const Note = () => {
  ...
  return isVisible ? (
    <div className="flex items-center gap-1.5 min-h-8 px-3 py-1.5 rounded-t-xl border-b border-brand-secondary/30 bg-gradient-to-r from-[#E0FAEC] to-[#D0FBE9] text-label-xs text-brand-primary shadow-sm">
      {/* Alert Icon */}

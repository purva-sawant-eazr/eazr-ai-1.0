...
const Answer = ({ children, isLoading = false }: Props) => (
  <div className="flex items-start mb-6">
    ...
    <div className="shrink-0 flex items-center justify-center">
      <div
        className={`size-7  ${isLoading ? "animate-spin" : ""}`}
    ...
    {/* Message Content */}
    <div className="ml-1.5 max-w-[60%] bg-white text-text-primary border border-brand-secondary/40 rounded-2xl px-4 py-2 shadow-sm hover:shadow-md transition-all duration-200">

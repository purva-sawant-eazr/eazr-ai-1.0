    ...
    <section className="relative py-24 max-md:py-16 max-sm:py-12 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl max-md:text-3xl max-sm:text-2xl font-bold text-text-primary mb-6 max-md:mb-4">
            Why We Do What We Do
          </h2>
          <p className="text-lg max-md:text-base max-sm:text-sm text-text-secondary max-w-3xl mx-auto leading-relaxed">
        ...
        >
          <div className="relative bg-gradient-to-br from-brand-primary/5 via-white to-brand-secondary/5 rounded-3xl p-10 max-md:p-8 max-sm:p-6 border border-brand-primary/20 shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden group">
            {/* Animated Background */}
            <div className="absolute inset-0 bg-gradient-to-r from-brand-primary/0 via-brand-secondary/5 to-brand-primary/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

            <div className="relative flex items-start gap-6 max-md:gap-5 max-sm:flex-col">
              <div className="flex-shrink-0 w-20 h-20 max-md:w-16 max-md:h-16 max-sm:w-14 max-sm:h-14 bg-gradient-to-br from-brand-primary to-brand-secondary rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                <Target className="w-10 h-10 max-md:w-8 max-md:h-8 max-sm:w-7 max-sm:h-7 text-white" />
              </div>
              <div className="flex-1">
                <h3 className="text-3xl max-md:text-2xl max-sm:text-xl font-bold text-text-primary mb-5 max-md:mb-4">
                  Our Mission
                </h3>
                <div className="space-y-4 max-md:space-y-3">
                  <p className="text-text-secondary text-lg max-md:text-base max-sm:text-sm leading-relaxed">
                    At Eazr, we're here to provide credit where it truly matters—<span className="font-semibold text-brand-primary">healthcare, education, and everyday essentials</span>.
                  </p>
                  <p className="text-text-secondary text-lg max-md:text-base max-sm:text-sm leading-relaxed">
                    We step in where traditional finance often steps away—when a family delays insurance, a student's future hangs by a fee, or a small shortfall disrupts daily life. <span className="font-semibold text-brand-primary">Eazr fills that gap—with purpose, not paperwork.</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-brand-secondary/10 to-transparent rounded-tr-full" />
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className="text-3xl max-md:text-2xl max-sm:text-xl font-bold text-text-primary mb-10 max-md:mb-8 max-sm:mb-6 text-center">
            Our Core Values
          </h3>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <h4 className="text-xl max-md:text-lg max-sm:text-base font-bold text-text-primary mb-3 max-md:mb-2 group-hover:text-brand-primary transition-colors duration-300">
                      {value.title}
                    </h4>
                    <p className="text-text-secondary text-base max-md:text-sm max-sm:text-xs leading-relaxed">
                      {value.description}
                    </p>
                  </div>
